...
class Motion{
     ...
     */
    static Initialize(prefix, theme, name, format, picturePath := A_Path.SupportFiles.ImageSearch, NewState := "Open", attempts := 3) {
 ...
 */
FindImage(imageName, x, y, w, h, shade := 100, picturePath := A_Path.SupportFiles.ImageSearch, attempts := 3){
